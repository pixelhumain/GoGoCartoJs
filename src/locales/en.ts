...
export const EN = {
  ...
  'collaborative.moderation.first.paragraph':
    "When ${element.undefinite} is added or modified, the update of the data is not instantaneous: ${element.definite} will initially appear 'grayed' on the map, and it will then be possible for all users logged to vote once and for this item. This vote is not an opinion, but a sharing of knowledge. If you know it, or know that it does not exist, then your knowledge interests us!",
  'collaborative.moderation.second.paragraph':
    'After a certain number of votes, ${element.definite} can then be automatically validated or refused. In case of dispute (both positive and negative votes), a moderator will intervene as soon as possible. We count on you!',
  ...
  'element.undefinite': 'an element',
  'elements.containing': '${element.plural} containing',
  'element.no.longer.exists': '${element.definite} no longer exists',
  'element.no.respect.charter': '${element.definite} not respect the charter',
  'element.referenced.several.times': '${element.definite} is referenced several times',
  ...
  'exists.and.i.validate.the.accuracy.of.the.given.informations':
    'exists, and I validate the accuracy of the given informations',
  ...
  'reject': 'Reject',
  'rejected.or.deleted.element': '(${element.definite} has been rejected or deleted)',
  'remove': 'Remove',
  ...
  'route.to.element': 'Route to ${element.definite}',
  ...
  'show.only.elements.to.moderate': 'Show only ${element.plural} to moderate',
  'show.only.elements.validation.process': 'Show only ${element.plural} in the process of validation',
