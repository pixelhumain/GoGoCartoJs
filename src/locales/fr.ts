...
export const FR = {
  ...
  'element.undefinite': "un élément",
  'element.plural': 'éléments',
  'elements.containing': '${element.plural} contenant',
  'element.no.longer.exists': "${element.definite} n'existe plus",
  'element.no.respect.charter': "${element.definite} ne respecte pas la charte",
  'element.referenced.several.times': "${element.definite} est référence plusieurs fois",
  ...
  'exists.and.i.validate.the.accuracy.of.the.given.informations':
    "existe et je valide l'exactitude des informations renseignées",
  ...
  'geolocation.error.refused': 'Géolocalisation refusée',
  'geolocation.error.failed': 'La géolocalisation a échoué',
  ...
  'iframe.initialized.position.map':
    "L'iframe sera initialisée dans la position actuelle de la carte. Déplacez la carte dans la position voulue avant d'ouvrir cette fenêtre !",
  'import': 'Import',
  ...
  'reject': 'Refuser',
  'rejected.or.deleted.element': '(${element.definite} a été refusé ou supprimé)',
  'remove': 'Supprimer',
  ...
  'route.to.element': 'Itinéraire vers ${element.definite}',
  ...
  'show.only.elements.to.moderate': 'Afficher uniquement les ${element.plural} à modérer',
  'show.only.elements.validation.process': 'Afficher uniquement les ${element.plural} en cours de validation',
