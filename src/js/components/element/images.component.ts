...
export class ImagesComponent
{
  ...
  {
    let navBtns = this.dom.find('.img-navigation-btn.next, .img-navigation-btn.prev');
  ...
  {          
    ...
    else this.currentImage.load(() => { this.onImageDisplayed(); });      
  };
  ...
  verticalAlignCurrentImage()
  {
    ...
    let imgBannerHeight = this.dom.find('.img-overlay').height();
