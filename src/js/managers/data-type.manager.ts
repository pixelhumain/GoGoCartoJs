...
export class DataTypeManager
{
  ...
  setDataType($dataType : AppDataType, $backFromHistory : boolean = false, $searchResult = null)
  {
    ...
    if ($dataType == AppDataType.SearchResults && $searchResult) 
    {
      ...
      let elements = App.elementsJsonModule.convertJsonElements($searchResult.data, true, true).elementsConverted; 
